package org.director.calendarWindow;
...
public class CalendarWindow extends Main{
	public static GridPane buildCalendarByYM(int year, int month){
        ...
        int firstDayInWeek          = DirectorInterface.getDayOfWeekByStr(yearStr+"-"+monthStr+"-01");
        int lastDayInWeek           = DirectorInterface.getDayOfWeekByStr(yearStr+"-"+monthStr+"-"+lastDayOfMonthStr); 
