...
public class SideMenu extends Main{
    ...
    public static StackPane buildMasterSideMenu(int state){
        ...
        mainSideMenuBtn[0].setOnAction(event -> LoadInterface.loadMasterCalendarWindowFunc(mainSideMenuBtn[0]));
        mainSideMenuBtn[2].setOnAction(event -> LoadInterface.loadMasterProfileWindowFunc(mainSideMenuBtn[2]));
        mainSideMenuBtn[3].setOnAction(event -> LoadInterface.loadMasterHelpWindowFunc(mainSideMenuBtn[3]));
        ...
        resourcesBtn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                if (resourcesBtn.isSelected()){
                    ...
                    listBtn.setOnAction(e -> LoadInterface.loadMasterResourcesListWindowFunc(listBtn));
                    requestsBtn.setOnAction(e -> LoadInterface.loadMasterResourcesRequestsWindowFunc(requestsBtn));
