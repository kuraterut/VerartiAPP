package src.master.resourceWindow;
...
public class ResourceWindow extends Main{
    public static BorderPane loadMasterResourcesListWindow(){
        ArrayList<String[]> resourceList = Connection.getMasterResourcesList(token);
        
        BorderPane root             = new BorderPane();
        StackPane sideMenuStack     = SideMenu.buildMasterSideMenu(1);
        ...
        for (int i = 0; i < resourceList.size(); i++){
            ...
            order.setOnAction(event -> loadMasterResourceOrderDialog(idStr));
    ...
    public static void loadMasterResourceOrderDialog(String idStr) {
    ...
    public static BorderPane loadMasterResourcesRequestsWindow(){
        ArrayList<String[]> resourceRequestsList = Connection.getMasterResourcesRequestsList(token);
