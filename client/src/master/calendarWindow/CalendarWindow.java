...
public class CalendarWindow extends Main{
	public static GridPane buildCalendarByYM(int year, int month){
        ...
        int firstDayInWeek          = LoadInterface.getDayOfWeekByStr(yearStr+"-"+monthStr+"-01");
        int lastDayInWeek           = LoadInterface.getDayOfWeekByStr(yearStr+"-"+monthStr+"-"+lastDayOfMonthStr); 
    ...
    public static BorderPane loadMasterCalendarWindow(){
        BorderPane root             = new BorderPane();
        
        StackPane sideMenuStack     = SideMenu.buildMasterSideMenu(0);
