...
public class Main extends Application{
    ...
    private static final double MENU_WIDTH = 200; // Ширина меню
    ...
    public BorderPane loadMainWindow(){
        ...
        Button side_menu_btn6       = new Button();
        Button side_menu_btn7       = new Button();
        Button side_menu_btn8       = new Button();
        ...
        exit_btn.setText("Выйти из аккаунта");
        ...
        side_menu_btn1.setText("Главная");        
        side_menu_btn2.setText("Сотрудники");
        side_menu_btn3.setText("Гости");
        side_menu_btn4.setText("Оборот");
        side_menu_btn5.setText("Настройки");
        side_menu_btn6.setText("Календарь");
        side_menu_btn7.setText("Ресурсы");
        side_menu_btn8.setText("Помощь");

        side_menu_btn1.setPrefHeight(50);
        side_menu_btn2.setPrefHeight(50);
        side_menu_btn3.setPrefHeight(50);
        side_menu_btn4.setPrefHeight(50);
        side_menu_btn5.setPrefHeight(50);
        side_menu_btn6.setPrefHeight(50);
        side_menu_btn7.setPrefHeight(50);
        side_menu_btn8.setPrefHeight(50);
        exit_btn.setPrefHeight(50);

        side_menu_btn1.setMaxWidth(Double.MAX_VALUE);
        side_menu_btn2.setMaxWidth(Double.MAX_VALUE);
        side_menu_btn3.setMaxWidth(Double.MAX_VALUE);
        side_menu_btn4.setMaxWidth(Double.MAX_VALUE);
        side_menu_btn5.setMaxWidth(Double.MAX_VALUE);
        side_menu_btn6.setMaxWidth(Double.MAX_VALUE);
        side_menu_btn7.setMaxWidth(Double.MAX_VALUE);
        side_menu_btn8.setMaxWidth(Double.MAX_VALUE);
        exit_btn.setMaxWidth(Double.MAX_VALUE);
        ...
        sideMenu.getChildren().addAll(  side_menu_btn1, 
                                        side_menu_btn2, 
                                        side_menu_btn3, 
                                        side_menu_btn4, 
                                        side_menu_btn5, 
